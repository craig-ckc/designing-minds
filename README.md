...
Before release, run `npm run lint`, `npm test`, and `npm run build` from the repository root, then complete the environment and provider checks in [docs/operations.md](./docs/operations.md).
